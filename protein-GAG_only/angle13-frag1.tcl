...
for {set i 0 } { $i < $nf } { incr i } { 
    ...
    for {set n 10 } { $n < 20 } { incr n 2} {
        set n1 [expr {$n+1}]

        set psi3 [[atomselect top "fragment 1 and name C1 O3 C3 C2 and residue $n to $n1"] get index]
        set tpsi3 [lrange $psi3 1 4]
        set dpsi3 [measure dihed "$tpsi3" ] 
        set phi3 [[atomselect top "fragment 1 and name O5 C1 O3 C3 and residue $n to $n1"] get index]
