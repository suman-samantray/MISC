...
for {set i 0 } { $i < $nf } { incr i } { 
    ...
    for {set n 0 } { $n < 8 } { incr n 2} {

        set n1 [expr {$n+1}]
        set n2 [expr {$n+2}]

        set ps [[atomselect top "fragment 0 and name C1 O4 C4 C3 and residue $n1 to $n2"] get index]
        set tps [lrange $ps 1 4]
        set dps [measure dihed "$tps" ] 
        set ph [[atomselect top "fragment 0 and name O5 C1 O4 C4 and residue $n1 to $n2"] get index]
